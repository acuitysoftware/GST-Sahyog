...
import { View, Text, StyleSheet, Image, Dimensions, ScrollView, Prassable, TouchableOpacity, Pressable, Modal } from 'react-native';
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.total_view}>
                    ...
                    <Card style={styles.box_view}>
                        <View style={styles.main_view}>
                            ...
                            <Text style={{ ...styles.total_text, color: colors.primaryFontColor }}>100</Text>
                        </View>
                ...
                <Card style={styles.total_sales_card}>
                    <View style={styles.sale_view}>
                        ...
                        <Text style={{ ...styles.sale_txt_number, color: colors.primaryFontColor }}>15200.00</Text>
                    </View>
                    <View style={styles.cardline} />
                    <View style={styles.sale_view}>
                        <Text style={{ ...styles.total_sale_txt, color: colors.primaryFontColor }}>CGST</Text>
                        <Text style={{ ...styles.sale_txt_number, color: colors.primaryFontColor }}>500.00</Text>
                    </View>
                    <View style={styles.cardline} />
                    <View style={styles.sale_view}>
